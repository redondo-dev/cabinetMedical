...
//           : "absolute left-0 mt-2 min-w-[200px]"
//       }
//       bg-white/20 backdrop-blur-lg border border-white/10 rounded-md shadow-lg z-50
//     `}
//     >
//       {items.map((item, index) => (
//         <li key={index} className="relative group/submenu">
//           <NavigationLink
//             href={item.link}
//             className="block px-4 py-2 text-white hover:bg-white/10 whitespace-nowrap"
//           >
//             {item.title}
//           </NavigationLink>
//           {item.submenu && renderSubmenuItems(item.submenu, index, true)}
...
//         <div
//           className={`fixed inset-y-0 right-0 w-full transform transition-transform duration-300 ease-in-out md:hidden ${
//             isOpen ? "translate-x-0" : "translate-x-full"
//           } z-40`}
//         >
//           <nav className="h-full overflow-y-auto bg-white/10 backdrop-blur-xl border-l border-white/20">
